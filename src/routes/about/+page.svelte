...
<section class="flex flex-col gap-4 justify-center max-w-[750px]">
	<h1 class="text-2xl sm:text-4xl">About me</h1>
	...
	<p class="sm:text-lg">
		I was born in rural Colorado, graduated high school in 2012, and then graduated from the
		University of Northern Colorado in 2019 with a two Bachelors degrees, one in Physics with an
		emphasis in Astronomy and the other in Software Engineering. After graduating I was able to find
		employment as a software engineer where I have been honing my programming and development skills
		for five years.
	</p>
